...
## Testimony
Now it is time to express your thoughts about the Author and 14DaysOfPython. You can leave your testimonial on this [link](https://testimonify.herokuapp.com/)
...
```sh
python script.py Asabeneh 14DaysOfPython
```
